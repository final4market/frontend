  ...
  return (
    <div className={styles.side_bar_container}>
      ...
      <ul className={styles.side_bar_ul}>
        ...
        <li className={styles.side_bar_li}>
          <Link to="/buyHistory" className={`${styles.side_bar_item} ${styles.side_bar_buy_history}`}>구매 내역</Link>
        </li>
        <li className={styles.side_bar_li}>
        ...
        <li className={styles.side_bar_li}>
          <Link to="/followList" className={`${styles.side_bar_item} ${styles.side_bar_follow_list}`}>팔로우 목록</Link>
        </li>
      </ul>
    </div>
  );
